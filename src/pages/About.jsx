          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-3">
              <p className="text-base md:text-xl">
                In today's fast-paced world, we often forget one crucial aspect
                of success—our well-being. At Respiro, we believe that
                productivity and health go hand in hand. That's why we've
                created a tool that helps you not only manage your time but also
                prioritize your health through mindful breaks.
              </p>
              <p>
                ...
                Respiro is here to help you stay balanced, focused, and
                energized.
              </p>
            </div>
          </div>
