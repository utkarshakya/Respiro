...
import { Footer, useTimer, Navbar } from "../../components";

function Pomodoro() {
  const { formatTime, start, pause, reset, isRunning } = useTimer(
    20 * 60
  );
      ...
      <div className="w-screen max-w-7xl flex flex-col items-center gap-5 bg-slate-800 mx-auto px-5 md:px-20">
        <div className="w-full h-full flex flex-col gap-5">
          ...
          <div className="w-fit mx-auto flex gap-5">
            <button
              className="w-fit mx-auto mb-10 rounded-full px-10 hover:px-12 transition-padding ease-in-out duration-300 cursor-pointer py-3 font-semibold bg-pink-500 hover:bg-pink-700"
